            ...
            <div className="product-guide-body">
                ...
                <div className="menu-product-guide-container">
                    <div className="menu-product-container">
                        <div className="product-menu-options" style={activate ? ({ color: "rgb(224, 216, 0)", borderBottom: "2px solid rgb(224, 216, 0)" }) : {}}>
                        ...
                        <div className="product-menu-options" style={balance ? ({ color: "rgb(224, 216, 0)", borderBottom: "2px solid rgb(224, 216, 0)" }) : {}}>
                            <div className="menu-balance" onClick={setBalanceTrue}>
                                Balance
							</div>
                        </div>
                        <div className="product-menu-options" style={cleanse ? ({ color: "rgb(224, 216, 0)", borderBottom: "2px solid rgb(224, 216, 0)" }) : {}}>
                            <div className="menu-cleanse" onClick={setCleanseTrue}>
                                Cleanse
							</div>
                        </div>

                        <div className="product-menu-options" style={matcha ? ({ color: "rgb(224, 216, 0)", borderBottom: "2px solid rgb(224, 216, 0)" }) : {}}>
                    ...
                    <div className='product-guide-container'>
                        ...
                        {activate ? (
                            <ProductGuideDisplay img={activatePic} viewBSA={false}
                                activateText="Unicity Activate is an approach to health that combines products, simple core principles, and supporting tools to help you embrace a metabolically healthy lifestyle. The program is based on metabolic flexibility, the ability to use both carbohydrate and stored fat as fuel for the body’s energy needs, for improved overall health."

                            />
                        ) : balance ? (
                            <ProductGuideDisplay img={balancePic} viewBSA={true}
                            ...
                            <ProductGuideDisplay img={cleansePic} viewBSA={true}
